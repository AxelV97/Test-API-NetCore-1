...
namespace TestingCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<TestingCoreContext>(options =>
            {
                options.UseSqlServer(Configuration.GetConnectionString("DefaultConenction"));
            });

            services.AddDefaultIdentity<ApplicationUser>()
                .AddEntityFrameworkStores<TestingCoreContext>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "Ejercicio RESTful Web API v1");
            });
